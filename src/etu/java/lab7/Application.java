...
public class Application {
    ...
    public void show() {
        ...
        generateHTML.addActionListener(new GenerateHTMLReportButtonListener());
    ...
    public class GenerateHTMLReportButtonListener implements ActionListener {
        ...
        private void generateReport(File file) {
            try {
                ...
                JOptionPane.showMessageDialog(window, "Report generated successfully!");
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(window, "Error generating report: " + ex.getMessage());
            }
        }
    }
    ...
    public class GeneratePDFReportButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            htmlChooser.setDialogTitle("Select HTML file to convert");
            ...
            if (htmlChooser.showOpenDialog(window) == JFileChooser.APPROVE_OPTION) {
                ...
                pdfChooser.setDialogTitle("Save PDF as");
        ...
        private void convertHTMLtoPDF(File htmlFile, File pdfFile) {
            try {
                ...
                JOptionPane.showMessageDialog(window, "PDF generated successfully!");
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(window, "Error generating PDF: " + ex.getMessage());
            }
        }
    }
